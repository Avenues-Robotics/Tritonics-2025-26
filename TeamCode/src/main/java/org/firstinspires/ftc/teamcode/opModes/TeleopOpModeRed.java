...
public class TeleopOpModeRed extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        launchSequenceClose = new TeleopTask(new SeriesTask(new SeriesTask(new RotateServo(0, launcher.RA), new RotateServo(0.2, launcher.DEC)), new LaunchSequence(intake, launcher,1.1, FtcDashboard.getInstance().getTelemetry())), () -> gamepad1.dpad_up);
        launchSequenceMiddle = new TeleopTask(new SeriesTask(new SeriesTask(new RotateServo(0.55, launcher.RA), new RotateServo(0.2, launcher.DEC)), new LaunchSequence(intake, launcher, 1.4, FtcDashboard.getInstance().getTelemetry())), () -> gamepad1.dpad_left);
        launchSequenceFar = new TeleopTask(new SeriesTask(new SeriesTask(new RotateServo(1, launcher.RA), new RotateServo(0.29, launcher.DEC)), new LaunchSequence(intake, launcher, 1.9, FtcDashboard.getInstance().getTelemetry())), () -> gamepad1.dpad_down);
        ...
        teleop = new ParallelTask (
                ...
                new ParallelTask(
                        new ParallelTask(launchSequenceClose, reverseIntake),
                        new ParallelTask(
