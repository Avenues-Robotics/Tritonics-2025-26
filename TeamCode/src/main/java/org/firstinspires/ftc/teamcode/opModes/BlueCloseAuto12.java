...
public class BlueCloseAuto12 extends TritonicsOpMode {
    ...
    public void runTritonicsOpMode() {
        ...
        shootToFirst = new PIDDrive(driveTrain, localization, new Pose2D(DistanceUnit.CM, -74.412, -125.148, AngleUnit.DEGREES, 90), 5, 5);
        firstPickup = new PIDDrive(driveTrain, localization, new Pose2D(DistanceUnit.CM, -54.412, -125.148, AngleUnit.DEGREES, 90), 5, 5);
        firstToGate = new PIDDrive(driveTrain, localization, new Pose2D(DistanceUnit.CM, -21.133, -141.002, AngleUnit.DEGREES, 90), 5, 10);
        ...
        shootToSecond = new PIDDrive(driveTrain, localization, new Pose2D(DistanceUnit.CM, -15.088, -126.597, AngleUnit.DEGREES, 90), 5, 5);
        ...
        shootToThird = new PIDDrive(driveTrain, localization, new Pose2D(DistanceUnit.CM, 46.948, -127.206, AngleUnit.DEGREES, 90), 5, 5);
